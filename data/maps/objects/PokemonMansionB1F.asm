PokemonMansionB1F_Object:
	...
	object_event 19, 25, SPRITE_POKE_BALL, STAY, NONE, 5, PP_UP;move to one of the upper floors, whichever vitamin needs swiches to get
	object_event 16, 20, SPRITE_POKEDEX, STAY, NONE, 6 ; person
	object_event  5, 13, SPRITE_POKE_BALL, STAY, NONE, 7, PP_UP;move to one of the card key stashes in Silph
