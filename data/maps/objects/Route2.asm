Route2_Object:
	...
	def_warp_events
	warp_event 18, 65, DIGLETTS_CAVE_ROUTE_2, 1
	warp_event  1, 11, VIRIDIAN_FOREST_NORTH_GATE, 2
	warp_event 16,  9, ROUTE_2_TRADE_HOUSE, 1
	...
	bg_event 13, 67, 6 ; Route2Text5

	def_object_events
	object_event 13, 54, SPRITE_POKE_BALL, STAY, NONE, 1, MOON_STONE
	object_event 13, 45, SPRITE_POKE_BALL, STAY, NONE, 2, HP_UP
	object_event  9, 57, SPRITE_COOLTRAINER_F, STAY, LEFT, 3, OPP_LASS, 18
