Route13_Object:
	...
	object_event 22,  5, SPRITE_COOLTRAINER_F, STAY, RIGHT, 5, OPP_COOLTRAINER_F, 6
	object_event 13,  4, SPRITE_COOLTRAINER_M, STAY, RIGHT, 6, OPP_BIRD_KEEPER, 2
	object_event 33,  7, SPRITE_BEAUTY, STAY, ANY_DIR, 7, OPP_BEAUTY, 4; spinner trainer
	object_event 35,  9, SPRITE_BEAUTY, STAY, DOWN, 8, OPP_BEAUTY, 5
