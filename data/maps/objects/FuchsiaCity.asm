FuchsiaCity_Object:
	...
	def_warp_events
	warp_event 15, 15, FUCHSIA_MART, 1
	warp_event 11, 27, FUCHSIA_BILLS_GRANDPAS_HOUSE, 1
	warp_event 15, 27, FUCHSIA_POKECENTER, 1
	...
	bg_event 16, 15, 14 ; MartSignText
	bg_event 16, 27, 15 ; PokeCenterSignText
	...
	bg_event  7, 11, 23 ; FuchsiaCityText23
	bg_event  9,  7, 24 ; FuchsiaCityText24

	def_object_events
	object_event 10, 10, SPRITE_YOUNGSTER, WALK, LEFT_RIGHT, 1 ; person
	...
	object_event 12,  6, SPRITE_BIRD, WALK, LEFT_RIGHT, 7 ; person
	object_event 30, 12, SPRITE_MONSTER, WALK, LEFT_RIGHT, 8 ; person
	object_event  8, 14, SPRITE_SEEL, STAY, NONE, 9 ; person
	object_event  6,  6, SPRITE_FOSSIL, STAY, NONE, 10 ; person
