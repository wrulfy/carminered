SaffronGym_Object:
	...
	object_event 10,  1, SPRITE_CHANNELER, STAY, DOWN, 2, OPP_CHANNELER, 15
	object_event 17,  1, SPRITE_YOUNGSTER, STAY, DOWN, 3, OPP_PSYCHIC_TR, 1
	object_event  3,  7, SPRITE_CHANNELER, STAY, DOWN, 4, OPP_CHANNELER, 16
	object_event 17,  7, SPRITE_YOUNGSTER, STAY, DOWN, 5, OPP_PSYCHIC_TR, 2
	object_event  3, 13, SPRITE_CHANNELER, STAY, DOWN, 6, OPP_CHANNELER, 17
	object_event 17, 13, SPRITE_SUPER_NERD, STAY, DOWN, 7, OPP_POKEMANIAC, 8
	object_event  3,  1, SPRITE_BEAUTY, STAY, DOWN, 8, OPP_BEAUTY, 11
