SafariZoneWest_Object:
	...
	warp_event 11, 11, SAFARI_ZONE_SECRET_HOUSE, 1
	warp_event  3,  3, SAFARI_ZONE_WEST_REST_HOUSE, 1

	def_bg_events
	bg_event  4,  4, 5 ; SafariZoneWestText5
	bg_event 21,  3, 6 ; SafariZoneWestText6
	...
	object_event  4,  9, SPRITE_POKE_BALL, STAY, NONE, 2, TM_DOUBLE_TEAM
	object_event 18, 18, SPRITE_POKE_BALL, STAY, NONE, 3, MAX_REVIVE
	object_event  9,  5, SPRITE_POKE_BALL, STAY, NONE, 4, GOLD_TEETH
