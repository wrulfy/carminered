Route12_Object:
	...
	object_event 13, 89, SPRITE_COOLTRAINER_M, STAY, LEFT, 4, OPP_JR_TRAINER_M, 9
	object_event 13, 73, SPRITE_SUPER_NERD, STAY, UP, 5, OPP_ROCKER, 2
	object_event 12, 40, SPRITE_FISHER, STAY, LEFT, 6, OPP_FISHER, 5
	object_event  9, 52, SPRITE_FISHER, STAY, RIGHT, 7, OPP_FISHER, 6
	object_event 12, 81, SPRITE_FISHER, STAY, DOWN, 8, OPP_FISHER, 10
	object_event 14, 35, SPRITE_POKE_BALL, STAY, NONE, 9, TM_SLUDGE
	object_event  9, 105, SPRITE_POKE_BALL, STAY, NONE, 10, IRON
