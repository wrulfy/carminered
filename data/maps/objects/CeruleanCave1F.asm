CeruleanCave1F_Object:
	...
	warp_event 26,  7, CERULEAN_CAVE_2F, 2
	...
	def_object_events
	object_event 19,  3, SPRITE_POKE_BALL, STAY, NONE, 1, FULL_RESTORE
	object_event  4,  5, SPRITE_POKE_BALL, STAY, NONE, 2, MAX_ELIXER
	object_event  7, 13, SPRITE_POKE_BALL, STAY, NONE, 3, NUGGET
