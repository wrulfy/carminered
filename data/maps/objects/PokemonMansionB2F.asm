PokemonMansionB2F_Object:
	...
	warp_event 21, 19, POKEMON_MANSION_B2F, 12
	warp_event 25,  7, POKEMON_MANSION_B2F, 13
	...
	warp_event 11, 11, POKEMON_MANSION_B2F, 4
	warp_event 27, 13, POKEMON_MANSION_B2F, 5
	...
	object_event 17, 20, SPRITE_POKE_BALL, STAY, NONE, 5, PP_UP
