ViridianForest_Object:
	...
	object_event 30, 33, SPRITE_YOUNGSTER, STAY, LEFT, 2, OPP_BUG_CATCHER, 2
	object_event 18,  7, SPRITE_YOUNGSTER, STAY, DOWN, 3, OPP_BUG_CATCHER, 1
	object_event  2, 18, SPRITE_YOUNGSTER, STAY, LEFT, 4, OPP_BUG_CATCHER, 3
	object_event 27, 20, SPRITE_POKE_BALL, STAY, NONE, 5, ANTIDOTE
