VictoryRoad2F_Object:
	...
	object_event 19,  8, SPRITE_ROCKER, STAY, DOWN, 3, OPP_TAMER, 5
	object_event  4,  2, SPRITE_SUPER_NERD, STAY, DOWN, 4, OPP_POKEMANIAC, 6
	object_event 26,  3, SPRITE_HIKER, STAY, LEFT, 5, OPP_HIKER, 16
	object_event 27,  5, SPRITE_POKE_BALL, STAY, NONE, 6, TM_FISSURE
	object_event 18,  9, SPRITE_POKE_BALL, STAY, NONE, 7, FULL_HEAL
	object_event  9, 11, SPRITE_POKE_BALL, STAY, NONE, 8, TM_HYPER_BEAM
	object_event 11,  0, SPRITE_POKE_BALL, STAY, NONE, 9, GUARD_SPEC
