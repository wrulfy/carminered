SilphCo5F_Object:
	...
	def_warp_events
	warp_event 24,  0, SILPH_CO_6F, 2;1 STAIRS
	warp_event 26,  0, SILPH_CO_4F, 2;2 STAIRS
	warp_event 20,  0, SILPH_CO_ELEVATOR, 1;3 ELEVATOR
	warp_event 27,  3, SILPH_CO_3F, 7;4 DONE
	warp_event  9, 15, SILPH_CO_9F, 5;5 DONE
	warp_event 11,  5, SILPH_CO_8F, 5;6 DONE
	warp_event  3, 15, SILPH_CO_3F, 9;7 DONE
	...
	object_event  1,  1, SPRITE_POKE_BALL, STAY, NONE, 7, PROTEIN
