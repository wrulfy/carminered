Route21_Object:
	...
	object_event  5, 71, SPRITE_SWIMMER, STAY, RIGHT, 6, OPP_SWIMMER, 14 ; TURN TO COOLTRAINER
	object_event 15, 71, SPRITE_SWIMMER, STAY, LEFT, 7, OPP_SWIMMER, 15; TURN TO SWIMING GENTLEMAN
	object_event 14, 56, SPRITE_FISHER, STAY, LEFT, 8, OPP_FISHER, 8; TURN TO YOUNGSTER
