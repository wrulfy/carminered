Route23_Object:
	...
	warp_event  2, 31, VICTORY_ROAD_1F, 1
	warp_event 15, 31, VICTORY_ROAD_2F, 2
	...
	object_event  9, 85, SPRITE_SWIMMER, STAY, DOWN, 3 ; person
	...
	object_event  9, 21, SPRITE_COOLTRAINER_M, STAY, ANY_DIR, 8 ; person
