MapSongBanks::
	...
	db MUSIC_ROUTES2, BANK(Music_Routes2) ; ROUTE_0 UNUSED_MAP_0B 
	...
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; SEAFOAM_ISLANDS_X
	...
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; LAVENDER_CLEFAIRY_HOUSE
	...
	db MUSIC_VERMILION, BANK(Music_Vermilion) ; FUCHSIA_GOOD_ROD_HOUSE
	...
	db MUSIC_CELADON, BANK(Music_Celadon) ; CINNABAR_LAB_FOSSIL_ROOM
	...
	db MUSIC_CINNABAR, BANK(Music_Cinnabar) ; ROUTE_12_SUPER_ROD_HOUSE
	...
	db MUSIC_VERMILION, BANK(Music_Vermilion) ; SAFARI_ZONE_SECRET_HOUSE
	...
	db MUSIC_CELADON, BANK(Music_Celadon) ; SECRET_CLUB_1F
	db MUSIC_CELADON, BANK(Music_Celadon) ; SECRET_CLUB_B1F
	db MUSIC_CINNABAR_MANSION, BANK(Music_CinnabarMansion); POKEMON_MANSION_TUNNEL
	db MUSIC_CINNABAR, BANK(Music_Cinnabar) ; CINNABAR_LAB_STORAGE_ROOM
	...
	db MUSIC_DUNGEON2, BANK(Music_Dungeon3) ; POKEMON_MANSION_B2F
