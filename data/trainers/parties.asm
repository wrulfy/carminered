...
BlaineData:
	...
	db $FF, 61, ELECTABUZZ, 61, MAGNETON, 62, RAICHU, 62, ELECTRODE, 62, STARMIE, 63, JOLTEON, 0

SabrinaData:
	db $FF, 45, LICKITUNG, 46, NINETALES, 47, GENGAR, 48, MUK, 49, CLEFABLE, 0
	db $FF, 61, LICKITUNG, 61, GOLDUCK, 62, MUK, 62, NINETALES, 62, GENGAR, 63, CLEFABLE, 0
