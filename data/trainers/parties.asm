...
; ROUTE 21
	db 47, FEAROW, RATICATE, SANDSLASH, NIDOKING, 0
; Route 11
...
; Route 3
	...
	db 14, JIGGLYPUFF, 0
; Route 4
	db 40, PARAS, PARASECT, PARAS, PARASECT, 0
; Mt. Moon 1F
...
; Vermilion Gym
	db 26, PONYTA, 0
; Extra for seafoam
	db 40, MACHOKE, KINGLER, OMASTAR, MACHAMP, 0	
...
; Route 15
	...
	db 35, WIGGLYTUFF, CLEFABLE, CHANSEY, 0
...
; Route 21
	db 47, SEAKING, GYARADOS, CLOYSTER, STARMIE, 0
	db 47, GOLDUCK, SLOWBRO, KINGLER, DEWGONG, 0
; Route 20
...
; Route 19
	db 32, SEAKING, POLIWHIRL, BLASTOISE, 0
	db 33, PSYDUCK, GOLDUCK, 0
	db 38, SEEL, HORSEA, DEWGONG, SEADRA, 0
	db 39, KABUTO, SHELLDER, GOLDUCK, 0
	db 39, KRABBY, POLIWHIRL, KINGLER, 0
	db 40, WARTORTLE, LAPRAS, 0
	db 36, TENTACOOL, SLOWPOKE, PSYDUCK, SHELLDER, STARYU, KRABBY, 0
; Route 20
	db 41, SLOWBRO, CLOYSTER, 0
	db 43, GYARADOS, GYARADOS, 0
	db 39, OMANYTE, SEADRA, SEAKING, KINGLER, 0
; Route 21
...
; Route 21
	db 48, TENTACRUEL, POLIWRATH, SNORLAX, 0
; FUCHSIA GYM
	db 40, MUK, 0
...
; Unused NOW FOR SAFFRON GYM
	db 40, CLEFAIRY, CLEFABLE, CLEFAIRY, CLEFABLE 0
; Route 19
	db 39, SEAKING, SEAKING, SEAKING, 0
	db 40, SEADRA, TENTACRUEL, 0
	db 39, POLIWHIRL, GYARADOS, SLOWBRO, 0
; Route 20
	db 40, GOLDUCK, SEAKING, SEADRA, 0
...
; Saffron Gym
	...
	db 45, GENGAR, 0
; REPRUPOSED FOR R21
	db 47, SLOWBRO, ALAKAZAM, PORYGON, HYPNO, 0
...
; Unused
	db 42, RATICATE, PERSIAN, ARBOK, TAUROS, 0

BirdKeeperData:
; Route 13
    db 36, FARFETCHD, FEAROW, PIDGEOT, 0
	db 35, PIDGEOTTO, PIDGEOTTO, FEAROW, AERODACTYL, 0
	db 37, DODRIO, CHARIZARD, 0
; Route 14
	db 39, PIDGEOT, 0
	db 35, GOLBAT, CLEFABLE, SCYTHER, 0
; Route 15
	db 33, PIDGEOTTO, DODUO, FEAROW, FARFETCHD, 0
	db 34, PIDGEOTTO, FEAROW, DODRIO, 0
; Route 18
	db 31, DODUO, PIDGEOTTO, FEAROW, FARFETCHD, 0
...
; Route 14
	db 35, DODRIO, FEAROW, PIDGEOTTO, 0
	db 36, PIDGEOTTO, FARFETCHD, 0
	db 35, FEAROW, FEAROW, FEAROW, 0
	db 34, DODUO, SPEAROW, DODRIO, FEAROW, 0

BlackbeltData:
; Fighting Dojo
	db $FF, 40, PRIMEAPE, 40, KANGASKHAN, 41, HITMONLEE, 41, HITMONCHAN, 42, MACHAMP, 0
	db 35, POLIWHIRL, PRIMEAPE, HITMONCHAN, 0
	db 36, MACHOKE, PINSIR, 0
	db 40, POLIWRATH, 0
...
; Silph Co. 6F
	db 30, VOLTORB, MAGNEMITE, STARYU, PIKACHU, PORYGON, 0;**
; Silph Co. 7F
...
; Silph Co. 11F
	db $FF, 41, RHYHORN, 41, PERSIAN, 42, FARFETCHD, 43, NIDORINA, 45, NIDOKING, 0
; Viridian Gym
	db $FF, 55, DUGTRIO, 56, FARFETCHD, 57, PERSIAN, 58, NIDOQUEEN, 59, NIDOKING, 60, RHYDON, 0
...
; Rocket Hideout B4F
	db 29, RATICATE, 0; UNUSED MOVED TO CHIEF
	db 29, RATICATE, 0; UNUSED MOVED TO CHIEF
...
; MANSION 3F
	db 43, EXEGGUTOR, CHANSEY, STARMIE, SNORLAX, RHYDON, TAUROS,  0
; Victory Road 1F
	db 42, IVYSAUR, WARTORTLE, CHARMELEON, CHARIZARD, 0
; ROUTE 21
	db 47, TANGELA, ALAKAZAM, KANGHASKAN, VENUSAUR, 0
; Unused
	db 50, NIDOKING, 0
	db 44, KINGLER, CLOYSTER, 0
; Viridian Gym
	db 40, SANDSLASH, DUGTRIO, 0
	db 44, RHYHORN, 0
...
; Saffron Gym
	...
	db 42, HAUNTER, NINETALES, 0
	db 41, HAUNTER, HAUNTER, MUK, 0
