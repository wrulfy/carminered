...
; Route 15
	db 33, GLOOM, WEEPINBELL, IVYSAUR, 0
	db 32, JIGGLYPUFF, WIGGLYTUFF, PIKACHU, RAICHU, 0
	db 35, CLEFAIRY, CLEFABLE, 0
	db 33, PONYTA, HORSEA, TANGELA, 0
; Route 20
...
BikerData:
; Route 13
	db 33, KOFFING, GRIMER, NIDOQUEEN, 0
; Route 14
	db 35, KOFFING, WEEZING, 0
; Route 15
	db 30, KOFFING, GRIMER, NIDORINA, NIDORINO, GOLBAT, ARBOK, 0
	db 33, ZUBAT, EKANS, NIDOKING, 0
; Route 16
...
; Route 17
	...
	db 34, VILEPLUME, 0
	db 30, PIKACHU, MAGNETON, ELECTRODE, 0
	db 31, BEEDRILL, MAGMAR, 0
	db 28, KOFFING, KOFFING, KOFFING, KOFFING, KOFFING, KOFFING, 0
; Route 14
	db 32, KOFFING, KOFFING, KOFFING, VICTREEBEL, 0
	db 33, NIDORINA, GLOOM, ARBOK, 0
	db 33, GOLBAT, NIDORINO, BEEDRILL, 0
...
; Route 19
	db 30, POLIWAG, PSYDUCK, SLOWPOKE, TENTACOOL, SHELLDER, 0
	db 30, GOLDEEN, KRABBY, SEEL, HORSEA, STARYU, 0
...
; Route 13
	db 32, BULBASAUR, IVYSAUR, VENUSAUR, 0
	db 29, POLIWHIRL, JIGGLYPUFF, CLEFAIRY, CUBONE, SEAKING, 0
; Route 20
	db 35, SEAKING, 0
	db 30, SHELLDER, SHELLDER, CLOYSTER, 0
	db 31, POLIWAG, SEAKING, 0
; Route 15
	db 33, PIDGEOTTO, CHANSEY, 0
	db 33, EXEGGCUTE, PERSIAN, 0
; Unused
...
BirdKeeperData:
; Route 13
    db $FF, 12, PIDGEY, 24, PIDGEOTTO, 36, PIDGEOT, 0
	db 25, SPEAROW, PIDGEY, PIDGEY, SPEAROW, SPEAROW, 0
	db 26, PIDGEY, PIDGEOTTO, SPEAROW, FEAROW, 0
; Route 14
	db 36, FARFETCHD, 0
	db 33, CLEFAIRY, GOLBAT, SCYTHER, 0
; Route 15
	db 32, PIDGEOTTO, DODUO, FEAROW, FARFETCHD, 0
	db 33, DODUO, DODUO, DODRIO, 0
; Route 18
...
BlackbeltData:
; Fighting Dojo
	db $FF, 40, PRIMEAPE, 28, KANGASKHAN, 41, HITMONLEE, 41, HITMONCHAN, 42, MACHAMP, 0
...
; Silph Co. 11F
	db $FF, 43, RHYHORN, 43, PERSIAN, 44, FARFETCHD, 45, NIDORINA, 47, NIDOKING, 0
; Viridian Gym
