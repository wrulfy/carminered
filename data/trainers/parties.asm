...
; Route 20
	db 44, DEWGONG, 0
	db 42, NIDOQUEEN, SNORLAX, CLOYSTER 0
...
; Unused
	db 41, RAPIDASH, RATICATE, GOLDUCK, MAROWAK, 0
	db 50, NIDOKING, 0
...
BlaineData:
	db $FF, 50, PORYGON, 51, MAGNETON, 52, ELECTABUZZ, 53, ELECTRODE, 54, STARMIE, 55, JOLTEON, 0
