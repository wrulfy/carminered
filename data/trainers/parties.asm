...
GiovanniData:
; Rocket Hideout B4F
	db $FF, 30, SANDSLASH, 32, RHYHORN, 34, DUGTRIO, 0
; Silph Co. 11F
	db $FF, 43, RHYHORN, 44, FARFETCHD, 45, NIDORINA, 47, NIDOKING, 0
; Viridian Gym
...
; Rocket Hideout B4F
	db 29, RATICATE, GOLBAT, SANDSLASH, 0
	db 29, RATICATE, GOLBAT, ARBOK, 0
	db 28, KOFFING, HYPNO, 0
; Pokémon Tower 7F
	db 30, ZUBAT, RATTATA, GOLBAT, 0
	db 31, MACHOKE, ARBOK, 0
	db 32, GRIMER, KOFFING, RATICATE, SANDSLASH, 0
; Unused, Route 10
