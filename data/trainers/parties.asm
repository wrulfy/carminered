...
; Viridian Forest
	...
	db 7, CATERPIE, KAKUNA, METAPOD, 0
	db 10, VENONAT, 0
; Route 3
	db 10, WEEDLE, CATERPIE, WEEDLE, PARAS, 0
...
; Route 6
	db 18, PARAS, VENONAT, BUTTERFREE, 0
	db 22, BEEDRILL, 0
...
; Celadon Gym
	db 30, METAPOD, KAKUNA, BUTTERFREE, 0
; Route 2 test
...
; REPRUPOSED FOR FUCHSIA GYM
	db 32, TENTACOOL, IVYSAUR, GRIMER, GLOOM, ARBOK, TENTACRUEL, 0
; Cinnabar Gym
...
; Celadon Gym
	db 30, VENONAT, PARAS, BEEDRILL, 0
; Route 13
...
; Silph Co. 10F
	db 33, MACHOKE, SANDSLASH, ARBOK, 0;17***
; Silph Co. 11F
...
; Silph Co. 2F
	db 32, CUBONE, GOLBAT, 0;23
	db 30, GRIMER, RATICATE, KOFFING, MACHOKE, ARBOK, 0;24**
; Silph Co. 3F
...
BrunoData:
	db $FF, 64, OMASTAR, 65, KABUTOPS, 65, ONIX, 66, BLASTOISE, 66, AERODACTYL, 67, GOLEM, 0

BrockData:
	db $FF, 12, RATTATA, 13, VOLTORB, 14, WIGGLYTUFF, 0
	db $FF, 61, WIGGLYTUFF, 61, PIDGEOT, 62, HYPNO, 62, CHANSEY, 62, KANGASKHAN, 63, TAUROS, 0 ; REMATCH

MistyData:
	db $FF, 21, STARYU, 22, SEEL, 23, MAROWAK, 0
	db $FF, 61, MAROWAK, 61, JYNX, 62, DEWGONG, 62, CLOYSTER, 62, STARMIE, 63, LAPRAS, 0 ; REMATCH

LtSurgeData:
	db $FF, 26, PONYTA, 27, CHARMELEON, 28, MAGMAR, 29, ARCANINE, 0
	db $FF, 61, MAGMAR, 61, WEEZING, 62, FLAREON, 62, CHARIZARD, 62, RAPIDASH, 63, ARCANINE, 0 ; REMATCH

ErikaData:
	db $FF, 32, KRABBY, 33, PINSIR, 34, BUTTERFREE, 35, PARASECT, 0
	db $FF, 61, BUTTERFREE, 61, SCYTHER, 62, VENOMOTH, 62, KINGLER, 62, PINSIR, 63, PARASECT, 0 ; REMATCH

KogaData:
	db $FF, 39, BEEDRILL, 40, ARBOK, 41, TENTACRUEL, 42, VENUSAUR, 43, WEEZING, 0
	db $FF, 61, ARBOK, 61, VICTREEBEL, 62, GOLBAT, 62, TENTACRUEL, 62, VILEPLUME, 63, WEEZING, 0 ; REMATCH

BlaineData:
	db $FF, 50, PORYGON, 51, ELECTRODE, 52, ELECTABUZZ, 53, STARMIE, 54, MAGNETON, 55, JOLTEON, 0
	db $FF, 61, ELECTABUZZ, 61, MAGNETON, 62, RAICHU, 62, ELECTRODE, 62, STARMIE, 63, JOLTEON, 0 ; REMATCH

SabrinaData:
	db $FF, 45, LICKITUNG, 46, NINETALES, 47, GENGAR, 48, MUK, 49, CLEFABLE, 0
	db $FF, 61, LICKITUNG, 61, GOLDUCK, 62, MUK, 62, NINETALES, 62, GENGAR, 63, CLEFABLE, 0 ; REMATCH
...
; Route 22
	db $FF, 56, PIDGEOT, 56, MACHAMP, 55, LAPRAS, 57, VICTREEBEL, 57, NINETALES, 61, BLASTOISE, 0
	db $FF, 56, PIDGEOT, 56, MACHAMP, 55, LAPRAS, 57, NINETALES, 57, POLIWRATH, 61, VENUSAUR, 0
	db $FF, 56, PIDGEOT, 56, MACHAMP, 55, LAPRAS, 57, POLIWRATH, 57, VICTREEBEL, 61, CHARIZARD, 0

Green3Data:
	db $FF, 71, PIDGEOT, 71, MACHAMP, 70, LAPRAS, 72, VICTREEBEL, 72, NINETALES, 75, BLASTOISE, 0
	db $FF, 71, PIDGEOT, 71, MACHAMP, 70, LAPRAS, 72, NINETALES, 72, POLIWRATH, 75, VENUSAUR, 0
	db $FF, 71, PIDGEOT, 71, MACHAMP, 70, LAPRAS, 72, POLIWRATH, 72, VICTREEBEL, 75, CHARIZARD, 0

LoreleiData:
	db $FF, 62, GOLDUCK, 63, SEADRA, 63, SLOWBRO, 64, VAPOREON, 64, POLIWRATH, 65, CLOYSTER, 0
...
AgathaData:
	db $FF, 66, MR_MIME, 67, VENOMOTH, 67, HYPNO, 68, JYNX, 68, ALAKAZAM, 69, EXEGGUTOR, 0

LanceData:
	db $FF, 68, DODRIO, 69, GOLBAT, 69, SCYTHER, 70, CHARIZARD, 70, GYARADOS, 71, DRAGONITE, 0
