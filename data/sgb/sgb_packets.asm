...
BlkPacket_TrainerCard:;PAL_SET PAL_MEWMON, PAL_CYANMON, PAL_YELLOWMON, PAL_GREYMON
	ATTR_BLK 10
	ATTR_BLK_DATA %010, 0,0,0, 03,12, 04,13 ; Boulder Badge
	ATTR_BLK_DATA %010, 1,1,0, 07,12, 08,13 ; Cascade Badge OK
	ATTR_BLK_DATA %010, 0,0,0, 11,12, 12,13 ; Thunder Badge
	ATTR_BLK_DATA %010, 2,2,0, 15,11, 16,12 ; Rainbow Badge OK
	ATTR_BLK_DATA %010, 2,2,0, 15,11, 16,12 ; Rainbow Badge OK
	ATTR_BLK_DATA %010, 2,2,0, 15,11, 16,12 ; Rainbow Badge OK
	ATTR_BLK_DATA %010, 3,3,0, 03,15, 04,16 ; Soul Badge
	ATTR_BLK_DATA %010, 1,1,0, 07,15, 08,16 ; Marsh Badge OK
	ATTR_BLK_DATA %010, 2,2,0, 11,15, 12,16 ; Volcano Badge OK
	ATTR_BLK_DATA %010, 3,3,3, 15,15, 16,16 ; Earth Badge OK
	ds 2, 0
...
PalPacket_TrainerCard:    PAL_SET PAL_MEWMON, PAL_CYANMON, PAL_YELLOWMON, PAL_GREYMON
