spinner: MACRO ;Didn't need to edit the whole macro just to copypaste jojocode
; \1: source
...
;changes to the second half of each chunk thanks to Jojobear13's code, just keep the rest of the code with the old macro
