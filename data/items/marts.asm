...
FuchsiaCashierText::
	script_mart ULTRA_BALL, GREAT_BALL, HYPER_POTION, REVIVE, FULL_HEAL, SUPER_REPEL, ETHER

UnusedCashierText:: ; unreferenced
	script_mart GREAT_BALL, HYPER_POTION, SUPER_POTION, FULL_HEAL, REVIVE

CinnabarCashierText::
	script_mart ULTRA_BALL, GREAT_BALL, MAX_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL,MAX_REVIVE, ELIXER
