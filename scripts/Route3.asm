...
Route3TrainerHeader2:
	trainer EVENT_BEAT_ROUTE_3_TRAINER_2, 4, Route3BattleText3, Route3EndBattleText3, Route3AfterBattleText3
...
Route3TrainerHeader7:
	trainer EVENT_BEAT_ROUTE_3_TRAINER_7, 1, Route3BattleText8, Route3EndBattleText8, Route3AfterBattleText8
	db -1 ; end
