...
INCLUDE "text/SeafoamIslandsX.asm"
...
INCLUDE "text/LavenderClefairyHouse.asm"
...
INCLUDE "text/CinnabarLabStorageRoom.asm"
...
INCLUDE "text/PokemonMansionTunnel.asm"
