...
; Lavender Town events
	...
	const_skip 3
	const EVENT_BEAT_GHOST_CLEFABLE
	const_skip
...
; Route 21 events
	...
	const EVENT_BEAT_ROUTE_21_TRAINER_9
...
; Route 23 events
	const_next $530
	const EVENT_PASSED_SNOWBADGE_CHECK
	const EVENT_PASSED_BURNBADGE_CHECK
	const EVENT_PASSED_GRUBBADGE_CHECK
	const EVENT_PASSED_MIASMABADGE_CHECK
	const EVENT_PASSED_POLTERBADGE_CHECK
	const EVENT_PASSED_POWERBADGE_CHECK
	const EVENT_PASSED_DRILLBADGE_CHECK
	const_skip
...
; Silph Co. events
	...
	const EVENT_BEAT_SILPH_CO_10F_TRAINER_2
	const_skip 4
...
; Pokémon Mansion events
	...
	const_skip 6
	const EVENT_BEAT_MANSION_5_TRAINER_0
	const EVENT_BEAT_MANSION_5_TRAINER_1
